...
fn test_ct_strings() {
    ...
    ct_string.push_str(&io::get_ct_string(&seq1, &paired1, &"example1".to_string()));
    ct_string.push_str(&io::get_ct_string(&seq2, &paired2, &"example2".to_string()));
    ct_string.push_str("\n\n"); // test robustness to adding in blank lines
    ct_string.push_str(&io::get_ct_string(&seq3, &paired3, &"example3".to_string()));
